	...
	s.router.Route("/api/v1", func(r chi.Router) {
		...
		r.Route("/platform", func(r chi.Router) {
			...
			r.Route("/intelligence", func(r chi.Router) {
				...
				r.Get("/reports/{id}/runs/{run_id}/attempts", s.listPlatformIntelligenceReportRunAttempts)
				r.Get("/reports/{id}/runs/{run_id}/events", s.listPlatformIntelligenceReportRunEvents)
