...
func (s *Server) setupRoutes() {
	...
	s.router.Route("/api/v1", func(r chi.Router) {
		...
		r.Route("/graph", func(r chi.Router) {
			...
			r.Get("/intelligence/insights", s.deprecatedAlias("/api/v1/platform/intelligence/insights", s.graphIntelligenceInsights))
			r.Get("/intelligence/quality", s.deprecatedAlias("/api/v1/platform/intelligence/quality", s.graphIntelligenceQuality))
			r.Get("/intelligence/metadata-quality", s.deprecatedAlias("/api/v1/platform/intelligence/metadata-quality", s.graphIntelligenceMetadataQuality))
			r.Get("/intelligence/claim-conflicts", s.deprecatedAlias("/api/v1/platform/intelligence/claim-conflicts", s.graphIntelligenceClaimConflicts))
			r.Get("/intelligence/leverage", s.deprecatedAlias("/api/v1/platform/intelligence/leverage", s.graphIntelligenceLeverage))
			r.Get("/intelligence/calibration/weekly", s.deprecatedAlias("/api/v1/platform/intelligence/calibration/weekly", s.graphIntelligenceWeeklyCalibration))
