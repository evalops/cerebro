...
- [x] Document the architectural decision:
  ...
  - [x] capture the first local breakpoint:
    - [x] `1K` stays comfortably single-node (`3.5s` total run, `43.8ms` copy-on-write)
    - [x] `10K` already crosses into uncomfortable latency (`15.5s` total run, `12.9s` search, `553.6ms` copy-on-write)
