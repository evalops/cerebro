...
| `github_check_run_completed` | `ensemble.tap.github.check_run.completed` | `github` | no | `cerebro.graphingest/v1alpha1` | `1.0.0` | - | `check_run`, `ci_workflow`, `repository`, `service` | `based_on`, `interacted_with`, `targets` | `actor_email`, `check_name`, `check_run_id`, `repository` | `commit_sha`, `conclusion`, `status`, `url` | `actor_email` |
